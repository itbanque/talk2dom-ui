  ...
  return (
    <main className="min-h-screen bg-white text-gray-800">
      ...
      <section className="max-w-3xl mx-auto pt-24 md:pt-32 pb-12 md:pb-20 px-4 md:px-6 text-left">
        <h1 className="text-2xl md:text-4xl font-bold mb-6">About Talk2Dom</h1>
        ...
        <h2 className="text-xl md:text-2xl font-semibold mt-8 md:mt-10 mb-3">Why I built Talk2Dom</h2>
        ...
        <h2 className="text-xl md:text-2xl font-semibold mt-8 md:mt-10 mb-3">Who I am</h2>
        ...
        <h2 className="text-xl md:text-2xl font-semibold mt-8 md:mt-10 mb-3">How I work</h2>
        <ul className="list-disc pl-6 space-y-2 text-base md:text-lg leading-relaxed">
