    ...
    <div className="sticky top-0 z-50 w-full bg-yellow-100 border-b border-yellow-300 text-yellow-800">
      <div className="overflow-x-auto">
        <div className="min-w-max text-sm py-2 px-4 whitespace-nowrap">
          ⚠️ 目前不支持邮箱直接登录，请使用 Google 或 GitHub · Email login is temporarily disabled. Please use Google or GitHub.
        </div>
      </div>
    </div>
    <Navbar />
      <main className="min-h-screen flex items-center justify-center dark:text-gray-100 px-4 py-6 md:py-12">
        <div className="w-full max-w-md p-6 md:p-8 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700">
          ...
          <div role="alert" aria-live="polite" className="text-center text-gray-600 dark:text-gray-300 py-4">
            Email login is currently unavailable. Please use Google or GitHub.
          </div>
